...
const dummyHistory = [
  [
    { sender: "Yuden", image: useIcon, message: `Hello` },
    { sender: "Jack", image: profile1, message: `Hi! How are you?` },
    { sender: "Yuden", image: useIcon, message: `I'm good, thanks!` },
    {
      sender: "Jack",
      image: profile1,
  ...
  [
    ...
    { sender: "Yuden", image: useIcon, message: `Hello! How are you?` },
    { sender: "Jason", image: profile2, message: `I'm good, thanks!` },
    { sender: "Yuden", image: useIcon, message: `That's great to hear!` },
    { sender: "Jason", image: profile2, message: `Hey` },
    { sender: "Yuden", image: useIcon, message: `Hello! How are you?` },
    { sender: "Jason", image: profile2, message: `I'm good, thanks!` },
  ],
  ...
  [
    { sender: "Yuden", image: useIcon, message: `Heyo` },
  ...
  [
    ...
    { sender: "Yuden", image: useIcon, message: `Bonjour! How are you?` },
